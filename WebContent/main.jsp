...
<body>
	<table style="float: left; margin-top: 55px;">
		...
		<input type="button" value="새글쓰기" style="position: absolute; left: 900px; top: 130px;">
	</table>
	<h2>구디SNS</h2>
	<hr>
	<select name="array" style="position: absolute; left: 900px;">
	...
	<iframe src="navi.jsp" width="100%" height="1000px" scrolling="no" frameborder="0"></iframe>
</body>
